...
namespace EFFrameTest2.Data.Infrastructure
{
    public abstract class RepositoryBase<T> where T : class
    {
        ...
        protected static readonly string SQL_Conn = ConfigurationManager.ConnectionStrings["ContactStore"].ConnectionString;

        private ContactDbContext dataContext;
        ...
        public ContactDbContext DataContext
        {
